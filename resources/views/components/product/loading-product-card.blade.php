<div class="bg-gray-light text-black w-39 rounded shadow-lg border-t-0 border border-gray-light-transparent shrink-0 select-none flex flex-col items-center">
